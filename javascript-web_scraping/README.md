...
0%# JavaScript - Web scraping
## Details
Amateur By: Guillaume, CTO at Holberton School Weight: 1Your score will be updated as you progress.## Resources
Read or watch :
...
## Learning Objectives
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/vyR6MzxawP38Wxze3Mcndg) 
...
* Your code should be  ` semistandard `  compliant. [Rules of Standard](https://intranet.hbtn.io/rltoken/qAB-HUJLZivo5Xbol93nKw) 
 + [semicolons on top](https://intranet.hbtn.io/rltoken/9PdDMIYjhr7rrMBwkwYHQw) 
. Also as reference: [AirBnB style](https://intranet.hbtn.io/rltoken/w9JTrKUoHboTrWZazNNw-w) 
...
[Documentation](https://intranet.hbtn.io/rltoken/9PdDMIYjhr7rrMBwkwYHQw) 

 ` $ sudo npm install semistandard --global
 ` ### Install request module and use it
[Documentation](https://intranet.hbtn.io/rltoken/YDUvl1fHJ5XgVj5X-dIvIw) 
...
* You must use the [Star wars API](https://intranet.hbtn.io/rltoken/Bv5vsiARwoF3Hr94FVFMZA) 
...
* The first argument is the API URL of the [Star wars API](https://intranet.hbtn.io/rltoken/Bv5vsiARwoF3Hr94FVFMZA) 
...
* File:  ` 6-completed_tasks.js ` 
 Self-paced manual review  Panel footer - Controls 
[Done with the mandatory tasks? Unlock 2 advanced tasks now!](https://intranet.hbtn.io/projects/2081/unlock_optionals) 
